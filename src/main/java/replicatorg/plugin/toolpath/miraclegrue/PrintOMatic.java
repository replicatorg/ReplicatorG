...
public class PrintOMatic implements MiracleGruePreference {
  ...
  public List<MiracleGrueOption> getOptions() {
    ...
    if (enabled.isSelected()) {
      ...
      options.add(new MiracleGrueOption("--infill-speed",Double.toString(flowRate)));
      ...
      options.add(new MiracleGrueOption("--travel-speed", Double.toString(feedRate)));
      ...
      //options.add(new MiracleGrueOption("fill.csv", "Extra Shells on Base (layers):", Double.toString(extraShellsOnBase)));
