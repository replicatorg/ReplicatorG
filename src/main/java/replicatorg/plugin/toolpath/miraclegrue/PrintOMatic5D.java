...
public class PrintOMatic5D implements MiracleGruePreference {
...
//				setValue("packingDensity", "85");
  ...
  public PrintOMatic5D() {
    ...
    baseName = "replicatorg.MiracleGrue.printOMatic5D.";
  ...
  public List<MiracleGrueOption> getOptions() {
    ...
    List<MiracleGrueOption> options = new LinkedList<MiracleGrueOption>();
...
//					+ "\n packingDensity=" + packingDensity
      ...
      options.add(new MiracleGrueOption("--fill-density",Double.toString(infillRatio)));
      options.add(new MiracleGrueOption("--infill-speed", Double.toString(feedRate)));
      options.add(new MiracleGrueOption("--travel-speed", Double.toString(travelFeedRate)));
      options.add(new MiracleGrueOption("--perimeter-speed", Double.toString(feedRate)));
      options.add(new MiracleGrueOption("--filament-diameter", Double.toString(filamentDiameter)));
//			options.add(new MiracleGrueOption("dimension.csv", "Filament Packing Density (ratio):", Double.toString(packingDensity)));
      //options.add(new MiracleGrueOption("carve.csv", "Perimeter Width over Thickness (ratio):", Double.toString(perimeterWidthOverThickness)));
      //options.add(new MiracleGrueOption("fill.csv", "Infill Width over Thickness (ratio):", Double.toString(infillWidthOverThickness)));
      options.add(new MiracleGrueOption("--layer-height", Double.toString(layerHeight)));
      //options.add(new MiracleGrueOption("fill.csv", "Extra Shells on Alternating Solid Layer (layers):", Double.toString(extraShellsOnAlternatingSolidLayer)));
      options.add(new MiracleGrueOption("--perimeters", Double.toString(extraShellsOnBase)));
      //options.add(new MiracleGrueOption("fill.csv", "Extra Shells on Sparse Layer (layers):", Double.toString(extraShellsOnSparseLayer)));
