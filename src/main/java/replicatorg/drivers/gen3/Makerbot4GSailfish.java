...
//			}
  ...
  public int getEEPROMParamInt(EEPROMParams param) {
    ...
    case ACCEL_SLOWDOWN_FLAG        :
      return getUInt8EEPROM(SailfishEEPROM.SLOWDOWN_FLAG);
    case DITTO_PRINT_ENABLED        :
      return getUInt8EEPROM(SailfishEEPROM.DITTO_PRINT_ENABLED);
    case EXTRUDER_HOLD              :
  ...
  public double getEEPROMParamFloat(EEPROMParams param) {
    ...
    case ACCEL_MAX_SPEED_CHANGE_B   :
      return (double)getUInt32EEPROM(SailfishEEPROM.ACCEL_MAX_SPEED_CHANGE_B) / 10.0d;
    default				:
  ...
  public void setEEPROMParam(EEPROMParams param, int val) {
    ...
    switch (param) {
    case ACCEL_SLOWDOWN_FLAG        :
      setUInt8EEPROM(SailfishEEPROM.SLOWDOWN_FLAG, (val != 0) ? 1 : 0);
      break;
    case DITTO_PRINT_ENABLED        :
      setUInt8EEPROM(SailfishEEPROM.DITTO_PRINT_ENABLED, (val != 0) ? 1 : 0);
      break;
    case EXTRUDER_HOLD              :
      setUInt8EEPROM(SailfishEEPROM.EXTRUDER_HOLD, (val != 0) ? 1 : 0);
      break;
    default				:
  ...
  public void setEEPROMParam(EEPROMParams param, long val) {
    ...
    switch (param) {
    case ACCEL_MAX_ACCELERATION_B   :
      setUInt32EEPROM(SailfishEEPROM.ACCEL_MAX_ACCELERATION_B, val);
      break;
    case ACCEL_EXTRUDER_DEPRIME_A   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_EXTRUDER_DEPRIME,    val);
      break;
    case ACCEL_EXTRUDER_DEPRIME_B   :
      setUInt32EEPROM(SailfishEEPROM.ACCEL_EXTRUDER_DEPRIME_B, val);
      break;
    default				:
      super.setEEPROMParam(param, val);
      break;
  ...
  public void setEEPROMParam(EEPROMParams param, double val) {
    ...
    switch (param) {
    case ACCEL_MAX_SPEED_CHANGE_B   :
      setUInt32EEPROM(SailfishEEPROM.ACCEL_MAX_SPEED_CHANGE_B, (long)(val * 10.0d));
      break;
    default				:
      super.setEEPROMParam(param, val);
      break;
