...
//		Base.logger.fine("Reconciling : "+machine.stepsToMM(steps).toString());
  ...
  public int getEEPROMParamInt(EEPROMParams param) {
    ...
    case AXIS_INVERSION             :
      return getUInt8EEPROM(JettyG3EEPROM.AXIS_INVERSION);
    case BUZZER_REPEATS             :
    ...
    case ENDSTOP_INVERSION          :
      return getUInt8EEPROM(JettyG3EEPROM.ENDSTOP_INVERSION);
    case ESTOP_CONFIGURATION        :
      return getUInt8EEPROM(JettyG3EEPROM.ESTOP_CONFIGURATION);
    ...
    case VERSION_HIGH               :
      return getUInt8EEPROM(JettyG3EEPROM.VERSION_HIGH);
    case VERSION_LOW                :
      return getUInt8EEPROM(JettyG3EEPROM.VERSION_LOW);
    default :
  ...
  public long getEEPROMParamUInt(EEPROMParams param) {
    ...
    case ACCEL_SLOWDOWN_LIMIT       :
      return getUInt32EEPROM(JettyG3EEPROM.ACCEL_SLOWDOWN_LIMIT);
  ...
  public double getEEPROMParamFloat(EEPROMParams param) {
    ...
    case ACCEL_ADVANCE_K            :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_ADVANCE_K) / 100000.0d;
    case ACCEL_ADVANCE_K2           :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_ADVANCE_K2) / 100000.0d;
    case ACCEL_EXTRUDER_DEPRIME_A   :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_EXTRUDER_DEPRIME) / 10.0d;
    case ACCEL_E_STEPS_PER_MM       :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_E_STEPS_PER_MM) / 10.0d;
    case ACCEL_MAX_SPEED_CHANGE_A   :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_SPEED_CHANGE_A) / 10.0d;
    case ACCEL_MAX_SPEED_CHANGE_X   :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_SPEED_CHANGE_X) / 10.0d;
    case ACCEL_MAX_SPEED_CHANGE_Y   :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_SPEED_CHANGE_Y) / 10.0d;
    case ACCEL_MAX_SPEED_CHANGE_Z   :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_SPEED_CHANGE_Z) / 10.0d;
    case ACCEL_MIN_FEED_RATE        :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_MIN_FEED_RATE) / 10.0d;
    case ACCEL_MIN_SEGMENT_TIME     :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_MIN_SEGMENT_TIME) / 10000.0d;
    case ACCEL_MIN_TRAVEL_FEED_RATE :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_MIN_TRAVEL_FEED_RATE) / 10.0d;
    case ACCEL_NOODLE_DIAMETER      :
      return (double)getUInt32EEPROM(JettyG3EEPROM.ACCEL_NOODLE_DIAMETER) / 100.0d;
    default :
  ...
  public void setEEPROMParam(EEPROMParams param, int val) {
    ...
    switch (param) {
    case ABP_COPIES                 :
      setUInt8EEPROM(JettyG3EEPROM.ABP_COPIES, val);
      break;
    case AXIS_INVERSION             :
      setUInt8EEPROM(JettyG3EEPROM.AXIS_INVERSION, val);
      break;
    case BUZZER_REPEATS             :
      setUInt8EEPROM(JettyG3EEPROM.BUZZER_REPEATS, val);
      break;
    case ENDSTOPS_USED              :
      setUInt8EEPROM(JettyG3EEPROM.ENDSTOPS_USED, val);
      break;
    case ENDSTOP_INVERSION          :
      setUInt8EEPROM(JettyG3EEPROM.ENDSTOP_INVERSION, val);
      break;
    case ESTOP_CONFIGURATION        :
      setUInt8EEPROM(JettyG3EEPROM.ESTOP_CONFIGURATION, val);
      break;
    case EXTRUDE_DURATION           :
      setUInt8EEPROM(JettyG3EEPROM.EXTRUDE_DURATION, val);
      break;
    case EXTRUDE_MMS                :
      setUInt8EEPROM(JettyG3EEPROM.EXTRUDE_MMS, val);
      break;
    case INVERTED_EXTRUDER_5D       :
      setUInt8EEPROM(JettyG3EEPROM.INVERTED_EXTRUDER_5D, val);
      break;
    case JOG_MODE_SETTINGS          :
      setUInt8EEPROM(JettyG3EEPROM.JOG_MODE_SETTINGS, val);
      break;
    case LCD_TYPE                   :
      setUInt8EEPROM(JettyG3EEPROM.LCD_TYPE, val);
      break;
    case MOOD_LIGHT_CUSTOM_BLUE     :
      setUInt8EEPROM(JettyG3EEPROM.MOOD_LIGHT_CUSTOM_BLUE, val);
      break;
    case MOOD_LIGHT_CUSTOM_GREEN    :
      setUInt8EEPROM(JettyG3EEPROM.MOOD_LIGHT_CUSTOM_GREEN, val);
      break;
    case MOOD_LIGHT_CUSTOM_RED      :
      setUInt8EEPROM(JettyG3EEPROM.MOOD_LIGHT_CUSTOM_RED, val);
      break;
    case MOOD_LIGHT_SCRIPT          :
      setUInt8EEPROM(JettyG3EEPROM.MOOD_LIGHT_SCRIPT, val);
      break;
    case OVERRIDE_GCODE_TEMP        :
      setUInt8EEPROM(JettyG3EEPROM.OVERRIDE_GCODE_TEMP, val);
      break;
    case PLATFORM_TEMP              :
      setUInt8EEPROM(JettyG3EEPROM.PLATFORM_TEMP, val);
      break;
    case PREHEAT_DURING_ESTIMATE    :
      setUInt8EEPROM(JettyG3EEPROM.PREHEAT_DURING_ESTIMATE, val);
      break;
    case STEPPER_DRIVER             :
      setUInt8EEPROM(JettyG3EEPROM.STEPPER_DRIVER, val);
      break;
    case TOOL0_TEMP                 :
      setUInt8EEPROM(JettyG3EEPROM.TOOL0_TEMP, val);
      break;
    case TOOL1_TEMP                 :
      setUInt8EEPROM(JettyG3EEPROM.TOOL1_TEMP, val);
      break;
    case VERSION_HIGH               :
      setUInt8EEPROM(JettyG3EEPROM.VERSION_HIGH, val);
      break;
    case VERSION_LOW                :
      setUInt8EEPROM(JettyG3EEPROM.VERSION_LOW, val);
      break;
    default :
      Base.logger.log(Level.WARNING, "setEEPROMParam(" + param + ", " + val + ") call failed");
      break;
    }
  }
  ...
  public void setEEPROMParam(EEPROMParams param, long val) {
    ...
    switch (param) {
    case ACCEL_CLOCKWISE_EXTRUDER   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_CLOCKWISE_EXTRUDER, val);
      break;
    case ACCEL_MAX_ACCELERATION_A   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_ACCELERATION_A, val);
      break;
    case ACCEL_MAX_ACCELERATION_X   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_ACCELERATION_X, val);
      break;
    case ACCEL_MAX_ACCELERATION_Y   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_ACCELERATION_Y, val);
      break;
    case ACCEL_MAX_ACCELERATION_Z   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_ACCELERATION_Z, val);
      break;
    case ACCEL_MAX_EXTRUDER_NORM    :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_EXTRUDER_NORM, val);
      break;
    case ACCEL_MAX_EXTRUDER_RETRACT :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_EXTRUDER_RETRACT, val);
      break;
    case ACCEL_MAX_FEEDRATE_A       :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_FEEDRATE_A, val);
      break;
    case ACCEL_MAX_FEEDRATE_B       :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_FEEDRATE_B, val);
      break;
    case ACCEL_MAX_FEEDRATE_X       :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_FEEDRATE_X, val);
      break;
    case ACCEL_MAX_FEEDRATE_Y       :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_FEEDRATE_Y, val);
      break;
    case ACCEL_MAX_FEEDRATE_Z       :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_FEEDRATE_Z, val);
      break;
    case ACCEL_MIN_PLANNER_SPEED    :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MIN_PLANNER_SPEED, val);
      break;
    case ACCEL_REV_MAX_FEED_RATE    :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_REV_MAX_FEED_RATE, val);
      break;
    case ACCEL_SLOWDOWN_LIMIT       :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_SLOWDOWN_LIMIT, val);
      break;
    case HOMING_FEED_RATE_X         :
      setUInt32EEPROM(JettyG3EEPROM.HOMING_FEED_RATE_X, val);
      break;
    case HOMING_FEED_RATE_Y         :
      setUInt32EEPROM(JettyG3EEPROM.HOMING_FEED_RATE_Y, val);
      break;
    case HOMING_FEED_RATE_Z         :
      setUInt32EEPROM(JettyG3EEPROM.HOMING_FEED_RATE_Z, val);
      break;
    case RAM_USAGE_DEBUG            :
      setUInt32EEPROM(JettyG3EEPROM.RAM_USAGE_DEBUG, val);
      break;
    default :
      Base.logger.log(Level.WARNING, "setEEPROMParam(" + param + ", " + val + ") call failed");
      break;
  ...
  public void setEEPROMParam(EEPROMParams param, double val) {
    ...
    switch (param) {
    case ACCEL_ADVANCE_K            :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_ADVANCE_K, (long)(val * 100000.0d));
      break;
    case ACCEL_ADVANCE_K2           :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_ADVANCE_K2, (long)(val * 100000.0d));
      break;
    case ACCEL_EXTRUDER_DEPRIME_A   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_EXTRUDER_DEPRIME, (long)(val * 10.0d));
      break;
    case ACCEL_E_STEPS_PER_MM       :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_E_STEPS_PER_MM, (long)(val * 10.0d));
      break;
    case ACCEL_MAX_SPEED_CHANGE_A   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_SPEED_CHANGE_A, (long)(val * 10.0d));
      break;
    case ACCEL_MAX_SPEED_CHANGE_X   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_SPEED_CHANGE_X, (long)(val * 10.0d));
      break;
    case ACCEL_MAX_SPEED_CHANGE_Y   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_SPEED_CHANGE_Y, (long)(val * 10.0d));
      break;
    case ACCEL_MAX_SPEED_CHANGE_Z   :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MAX_SPEED_CHANGE_Z, (long)(val * 10.0d));
      break;
    case ACCEL_MIN_FEED_RATE        :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MIN_FEED_RATE, (long)(val * 10.0d));
      break;
    case ACCEL_MIN_SEGMENT_TIME     :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MIN_SEGMENT_TIME, (long)(val * 10000.0d));
      break;
    case ACCEL_MIN_TRAVEL_FEED_RATE :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_MIN_TRAVEL_FEED_RATE, (long)(val * 10.0d));
      break;
    case ACCEL_NOODLE_DIAMETER      :
      setUInt32EEPROM(JettyG3EEPROM.ACCEL_NOODLE_DIAMETER, (long)(val * 100.0d));
      break;
    default :
      Base.logger.log(Level.WARNING, "setEEPROMParam(" + param + ", " + val + ") call failed");
      break;
