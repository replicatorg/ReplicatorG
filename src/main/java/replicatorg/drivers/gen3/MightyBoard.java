...
//		System.err.println("Extra features: ch abp "+Integer.toString(ef.abpChannel));
  ...
  public int getEEPROMParamInt(EEPROMParams param) {
    ...
    case ACCEL_EXTRUDER_DEPRIME_A   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.EXTRUDER_DEPRIME_STEPS + 0*2);
    case ACCEL_EXTRUDER_DEPRIME_B   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.EXTRUDER_DEPRIME_STEPS + 1*2);
    case ACCEL_MAX_ACCELERATION_A   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 3*2);
    case ACCEL_MAX_ACCELERATION_B   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 4*2);
    case ACCEL_MAX_ACCELERATION_X   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 0*2);
    case ACCEL_MAX_ACCELERATION_Y   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 1*2);
    case ACCEL_MAX_ACCELERATION_Z   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 2*2);
    case ACCEL_MAX_EXTRUDER_NORM    :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_NORMAL_MOVE);
    case ACCEL_MAX_EXTRUDER_RETRACT :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_EXTRUDER_MOVE);
    case ACCEL_MAX_SPEED_CHANGE_A   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 3*2);
    case ACCEL_MAX_SPEED_CHANGE_B   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 4*2);
    case ACCEL_MAX_SPEED_CHANGE_X   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 0*2);
    case ACCEL_MAX_SPEED_CHANGE_Y   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 1*2);
    case ACCEL_MAX_SPEED_CHANGE_Z   :
      return read16FromEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 2*2);
    case ACCEL_SLOWDOWN_FLAG        :
      return getUInt8EEPROM(MightyBoard6X2EEPROM.SLOWDOWN_FLAG);
    case PREHEAT_DURING_PAUSE       :
      return getUInt8EEPROM(JettyMBEEPROM.HEAT_DURING_PAUSE);
    case OVERRIDE_GCODE_TEMP        :
      return getUInt8EEPROM(JettyMBEEPROM.OVERRIDE_GCODE_TEMP);
    default :
  ...
  public double getEEPROMParamFloat(EEPROMParams param) {
    ...
    case ACCEL_ADVANCE_K            :
      return (double)getUInt32EEPROM(MightyBoard6X2EEPROM.JKN_ADVANCE_K) / 100000.0d;
    case ACCEL_ADVANCE_K2           :
      return (double)getUInt32EEPROM(MightyBoard6X2EEPROM.JKN_ADVANCE_K2) / 100000.0d;
    default :
  ...
  public void setEEPROMParam(EEPROMParams param, int val) {
    ...
    switch (param) {
    case ACCEL_EXTRUDER_DEPRIME_A   :
      write16ToEEPROM(MightyBoard6X2EEPROM.EXTRUDER_DEPRIME_STEPS + 0*2, val);
      break;
    case ACCEL_EXTRUDER_DEPRIME_B   :
      write16ToEEPROM(MightyBoard6X2EEPROM.EXTRUDER_DEPRIME_STEPS + 1*2, val);
      break;
    case ACCEL_MAX_ACCELERATION_A   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 3*2, val);
      break;
    case ACCEL_MAX_ACCELERATION_B   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 4*2, val);
      break;
    case ACCEL_MAX_ACCELERATION_X   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 0*2, val);
      break;
    case ACCEL_MAX_ACCELERATION_Y   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 1*2, val);
      break;
    case ACCEL_MAX_ACCELERATION_Z   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_AXIS + 2*2, val);
      break;
    case ACCEL_MAX_EXTRUDER_NORM    :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_NORMAL_MOVE, val);
      break;
    case ACCEL_MAX_EXTRUDER_RETRACT :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_ACCELERATION_EXTRUDER_MOVE, val);
      break;
    case ACCEL_MAX_SPEED_CHANGE_A   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 3*2, val);
      break;
    case ACCEL_MAX_SPEED_CHANGE_B   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 4*2, val);
      break;
    case ACCEL_MAX_SPEED_CHANGE_X   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 0*2, val);
      break;
    case ACCEL_MAX_SPEED_CHANGE_Y   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 1*2, val);
      break;
    case ACCEL_MAX_SPEED_CHANGE_Z   :
      write16ToEEPROM(MightyBoard6X2EEPROM.MAX_SPEED_CHANGE + 2*2, val);
      break;
    case ACCEL_SLOWDOWN_FLAG        :
      setUInt8EEPROM(MightyBoard6X2EEPROM.SLOWDOWN_FLAG, (val != 0) ? 1 : 0);
      break;
    case PREHEAT_DURING_PAUSE       :
      setUInt8EEPROM(JettyMBEEPROM.HEAT_DURING_PAUSE, (val != 0) ? 1 : 0);
      break;
    case OVERRIDE_GCODE_TEMP        :
      setUInt8EEPROM(JettyMBEEPROM.OVERRIDE_GCODE_TEMP, (val != 0) ? 1 : 0);
      break;
    default :
  ...
  public void setEEPROMParam(EEPROMParams param, double val) {
    ...
    switch (param) {
    case ACCEL_ADVANCE_K            :
      setUInt32EEPROM(MightyBoard6X2EEPROM.JKN_ADVANCE_K, (long)(val * 100000.0d));
      break;
    case ACCEL_ADVANCE_K2           :
      setUInt32EEPROM(MightyBoard6X2EEPROM.JKN_ADVANCE_K2, (long)(val * 100000.0d));
      break;
    default :
      Base.logger.log(Level.WARNING, "setEEPROMParam(" + param + ", " + val + ") call failed");
      break;
